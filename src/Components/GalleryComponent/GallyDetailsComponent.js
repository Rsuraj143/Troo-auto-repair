...
const GallyDetailsComponent = () => {
  return (
    <section className="troo-da-photo-gallery-deatail-section padding-top padding-bottom" id="troo-da-photo-gallery-deatail-section">
      ...
      <div className="row">
       ...
       <div className="row">
         <div className="col-md-12">
           <div className="photo-gallery-deatail-text">
            <h2>Description</h2>
       ...
       <div className="row">
        <div className="col-md-6">
          <div className="photo-gallery-deatail-con">
        ...
        <div className="col-md-6">
          <div className="photo-gallery-deatail-img-col">
